package cn.chujiang.security.server.oauth2;
...
import cn.chujiang.security.common.oauth2.token.store.RedisTemplateTokenStore;
import cn.chujiang.security.oauth.model.properties.PermitUrlProperties;
import cn.chujiang.security.server.oauth2.client.RedisClientDetailsService;
import cn.chujiang.security.server.oauth2.code.RedisAuthorizationCodeServices;
...
@Configuration
@Slf4j
public class OAuth2ServerConfig extends ClientDetailsServiceConfiguration {
