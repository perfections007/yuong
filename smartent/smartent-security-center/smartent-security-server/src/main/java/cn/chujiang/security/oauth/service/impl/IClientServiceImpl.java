package cn.chujiang.security.oauth.service.impl;
...
import cn.chujiang.security.oauth.dao.ClientDao;
import cn.chujiang.security.oauth.dao.SysClientServiceDao;
import cn.chujiang.security.oauth.dto.ClientDto;
import cn.chujiang.security.oauth.model.Client;
import cn.chujiang.security.oauth.service.IClientService;
...
//		}
	...
	public PageResult<Client> listRoles(Map<String, Object> params) {
        ...
        return PageResult.<Client>builder().data(pageInfo.getList()).code(0).total(pageInfo.getTotal()).build()  ;
