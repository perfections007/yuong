...
public class MyGenerator {
    ...
    public static void main(String[] args) {
       ...
       // gc.setXmlName("%sEntity");
        mpg.setGlobalConfig(gc);
        
        // 数据源配置
        DataSourceConfig dsc = new DataSourceConfig();
        dsc.setUrl("jdbc:mysql://192.168.2.240:3306/smartent?useUnicode=true;characterEncoding=utf8;useSSL=false;serverTimezone=UTC");
        ...
        pc.setParent("cn.chujiang");//你哪个父目录下创建包
